...
from monitor_client import MonitorError, MonitorPool
...
def producer_thread(producer_id: int,
    ...
    Watek producenta.
    """
    # Kazdy watek pobiera instancje monitora z puli
    monitor_client = monitor_pool.get_monitor(monitor_name)
    ...
    # Nie zamykamy monitor_client, pula zarzadza jego cyklem zycia
...
if __name__ == "__main__":
    # Tworzymy jedna pule monitorow dla calej aplikacji
    monitor_pool = MonitorPool(SERVER_ADDRESS)
    ...
    # Zamkniecie wszystkich polaczen w puli po zakonczeniu pracy
    monitor_pool.close_all()
