...
if __name__ == '__main__':
    ...
    print("  GET    /api/v1/authors/{id}     - Get author details")
    print("  PUT    /api/v1/authors/{id}     - Update author (full)")
    print("  PATCH  /api/v1/authors/{id}     - Update author (partial)")
    print("  DELETE /api/v1/authors/{id}     - Delete author")
    print("\nBooks Collection with Pagination:")
    print("  GET    /api/v1/books?page=1&limit=5  - List books (paginated)")
    print("  POST   /api/v1/books               - Create new book")
    print("  GET    /api/v1/books/{id}          - Get book details")
    print("  DELETE /api/v1/books/{id}          - Delete book")
    print(f"\nSample data: {len(authors)} authors, {len(books)} books")
